...
├── Services/          ← RemindersService, CalendarService, HealthService, AIBriefingService, CloudKitService (stub), PermissionsManager, HealthKitAuthorizationService
├── ViewModels/        ← HealthViewModel, AIBriefingViewModel
├── AI/                ← LLMProvider protocol, MLXProvider, GroqProvider, ClaudeProvider (stub), OpenAIProvider (stub), HealthSummaryPromptBuilder
